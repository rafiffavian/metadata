                   ...
                   <div class="row mt-2">
                        <ul>
                            <li style="margin:20px 0;">
                                <h2><a href="{{route('sim.show',1)}}">Layanan Perencanaan</a></h2>
                    ...
                    <div class="row mt-2">
                        <ul>
                            <li style="margin:20px 0;">
                                <h2><a href="{{route('sim.show',1)}}">Layanan Penetapan</a></h2>
                                {{-- <a href="{{route('sim.show',$sims->id)}}">{{$sims->name}}</a><br> --}}
                                {{-- <small><a href="/edit-matkul/sis-infor-akun">Edit</a>&nbsp;<a href=""></a></small>
                                <small><a href="/edit-matkul/sis-infor-akun">Delete</a>&nbsp;<a href=""></a></small> --}}
                            </li>
                    ...
                    <div class="row mt-2">    
                        <ul>
                            <li style="margin:20px 0;">
                                <h2><a href="{{route('sim.show',1)}}">Layanan Peremajaan</a></h2>
                                {{-- <a href="{{route('sim.show',$sims->id)}}">{{$sims->name}}</a><br> --}}
                                {{-- <small><a href="/edit-matkul/sis-infor-akun">Edit</a>&nbsp;<a href=""></a></small>
                                <small><a href="/edit-matkul/sis-infor-akun">Delete</a>&nbsp;<a href=""></a></small> --}}
                            </li>
                    ...
                    <div class="row mt-2">    
                        <ul>
                            <li style="margin:20px 0;">
                                <h2><a href="{{route('sim.show',1)}}">Layanan kenaikan Pangkat</a></h2>
                                {{-- <a href="{{route('sim.show',$sims->id)}}">{{$sims->name}}</a><br> --}}
                                {{-- <small><a href="/edit-matkul/sis-infor-akun">Edit</a>&nbsp;<a href=""></a></small>
                                <small><a href="/edit-matkul/sis-infor-akun">Delete</a>&nbsp;<a href=""></a></small> --}}
                            </li>
